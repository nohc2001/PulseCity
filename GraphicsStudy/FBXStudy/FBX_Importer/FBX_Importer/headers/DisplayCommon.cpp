...
void DisplayString(const char* pHeader, const char* pValue /* = "" */, const char* pSuffix /* = "" */, bool linechange)
{
    FbxString lString;
    ...
    lString += pValue;
    lString += pSuffix;
    if(linechange) lString += "\n";
    PrintString(lString);
}

void DisplayBool(const char* pHeader, bool pValue, const char* pSuffix /* = "" */, bool linechange)
{
    FbxString lString;
...
void DisplayInt(const char* pHeader, int pValue, const char* pSuffix /* = "" */, bool linechange)
{
    FbxString lString;
...
void DisplayDouble(const char* pHeader, double pValue, const char* pSuffix /* = "" */, bool linechange)
{
    FbxString lString;
...
void Display2DVector(const char* pHeader, FbxVector2 pValue, const char* pSuffix  /* = "" */, bool linechange)
{
    FbxString lString;
...
void Display3DVector(const char* pHeader, FbxVector4 pValue, const char* pSuffix /* = "" */, bool linechange)
{
    FbxString lString;
    FbxString lFloatValue1 = (float)pValue[0];
    FbxString lFloatValue2 = (float)pValue[1];
...
void Display4DVector(const char* pHeader, FbxVector4 pValue, const char* pSuffix /* = "" */, bool linechange)
{
    FbxString lString;
    FbxString lFloatValue1 = (float)pValue[0];
    FbxString lFloatValue2 = (float)pValue[1];
...
void DisplayColor(const char* pHeader, FbxPropertyT<FbxDouble3> pValue, const char* pSuffix /* = "" */, bool linechange)
...
void DisplayColor(const char* pHeader, FbxColor pValue, const char* pSuffix /* = "" */, bool linechange)
{
    FbxString lString;
