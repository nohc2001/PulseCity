...
start /affinity FFFF "Server1-Zone63" /D "!SERVER_CWD!" cmd /k ""!SERVER_EXE!" 63 9063 63"
start /affinity FFFF "Server1-Zone64" /D "!SERVER_CWD!" cmd /k ""!SERVER_EXE!" 64 9064 64"
