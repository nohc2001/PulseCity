...
void Zone::Update(float deltaTime) {
    ...
    // Dynamic ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Æ® ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Æ®
    ...
    // ï¿½æµ¹ Ã³ï¿½ï¿½ (Dynamic ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Æ® ï¿½ï¿½)
    {
        TourID += 1;
        for (auto& ch : chunck) {
            ...
            // Tourï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ IndexRange ï¿½ï¿½ï¿½ï¿½
        ...
        for (int ri = 0; ri < outlen; ++ri) {
            for (int i = ir[ri].start; i <= ir[ri].end; ++i) {
                ...
                dbgWarn(gbj1->chunkAllocIndexs == nullptr,
                    cout << "Zone" << zoneId << " WARN - DynamicObject_" << i << " ï¿½ï¿½ ï¿½ï¿½ï¿½ÔµÇ´ï¿½ Ã»Å©ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½Í°ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½Ï´ï¿½.\n";
                    continue;)

                //Shapeï¿½Îºï¿½ï¿½ï¿½ OBBï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½Þ´Â´ï¿½.
                        ...
                        for (int u = 0; u < c->Dynamic_gameobjects.size; ++u) {
                            ...
                            if (fsl1 + fsl2 > dist.fast_square_of_len3) {
                                ...
                                if (gbj1->tickLVelocity.fast_square_of_len3 <= 0.001f) {
                                    // ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Æ®ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½Ñ¾î°£ï¿½ï¿½.
                                    goto GOTO_NEXTOBJ;
                                }
                            }
                        }
                ...
                // ï¿½Æ¸ï¿½ ï¿½æµ¹Ã³ï¿½ï¿½ï¿½Ï¸é¼­ tickVelocityï¿½ï¿½ ï¿½Ù¾ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½.
                // ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ afterï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½Þ¶ï¿½ï¿½ï¿½ï¿½ï¿½.
                gbj1->worldMat.pos += gbj1->tickLVelocity;
...
int Zone::NewPlayer(SendDataSaver& sds, Player* obj, int clientIndex) {
    ...
    // ï¿½ï¿½ï¿½ï¿½ Å¬ï¿½ï¿½ï¿½Ì¾ï¿½Æ®ï¿½é¿¡ï¿½Ô´ï¿½ CommonSDSï¿½ï¿½
...
void Zone::RemovePlayer(int clientIndex) {
    ...
    // ï¿½ï¿½ï¿½ï¿½ Zoneï¿½ï¿½ Ã»Å©ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ ï¿½Ã·ï¿½ï¿½Ì¾î¸¦ ï¿½ï¿½ï¿½ï¿½.
    int n = 0;
    ...
    // ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ Å¬ï¿½ï¿½ï¿½Ì¾ï¿½Æ®ï¿½é¿¡ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ ï¿½Ë¸ï¿½
    Sending_DeleteGameObject(CommonSDS, objindex);

    // ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Æ® ï¿½è¿­ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ (ï¿½Þ¸ï¿½ ï¿½ï¿½ï¿½ï¿½ X)
...
void Zone::SpawnPortal() {
    ...
    // "Portal" Shapeï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ shapeindexï¿½ï¿½ -1ï¿½ï¿½ ï¿½ï¿½
...
void Zone::CheckPortalCollision(Player* p) {
    ...
    for (int i = 0; i < portals.size(); ++i) {
        ...
        if (dist2 <= r * r) {
            ...
            // Worldï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ ï¿½Ìµï¿½ï¿½ï¿½ ï¿½ï¿½Ã»
...
void Zone::SpawnObjects() {
    // ï¿½Ù²ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½Â°ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Æ® ï¿½ï¿½ï¿½ï¿½
    // Static ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Æ® ï¿½ï¿½ï¿½ï¿½
    // TODO: ï¿½ï¿½ï¿½ï¿½ Shape ï¿½Ì¸ï¿½ï¿½ï¿½ ï¿½Ù²ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½Â´ï¿½ï¿½ï¿½ È®ï¿½ï¿½ ï¿½Ê¿ï¿½
...
void Zone::GridCollisionCheck() {
    ...
    for (AstarNode* node : allnodes) {
        ...
        //// Static ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Æ®ï¿½ï¿½ ï¿½æµ¹ ï¿½Ë»ï¿½
...
void Zone::FireRaycast(GameObject* shooter, vec4 rayStart, vec4 rayDirection, float rayDistance, float damage) {
    ...
    // ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ Å¬ï¿½ï¿½ï¿½Ì¾ï¿½Æ®ï¿½é¿¡ï¿½ï¿½ Ray ï¿½ï¿½ï¿½ï¿½
