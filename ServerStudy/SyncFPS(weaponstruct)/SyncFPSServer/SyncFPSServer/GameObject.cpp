...
void World::Init() {
	...
	//Quest Table
	{
		...
		q->PushReq(QuestType::KillMonster, 1, 10); // 1번째 몬스터 10마리 처치
		...
		q->PushReq(QuestType::KillMonster, 0, 15); // 0번째 몬스터 15마리 처치
	...
	//NPC Talk Table
	{
		...
		NPCTalkTable.push_back(NPCTalkData(L"맥스", L"그 녀석들을 닥치는 대로 소탕해줘. 한 15명쯤은 필요해.")); // 12
