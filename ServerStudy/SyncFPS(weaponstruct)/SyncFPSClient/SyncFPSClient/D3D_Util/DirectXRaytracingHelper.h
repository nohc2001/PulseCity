...
public:
    ...
    bool operator==(const ShaderRecord& sr) const {
        bool b = (shaderIdentifier.ptr == sr.shaderIdentifier.ptr);
        b = b && (shaderIdentifier.size == sr.shaderIdentifier.size);
        b = b && (localRootArguments.size == sr.localRootArguments.size);
        UINT64* lptr = (UINT64*)localRootArguments.ptr;
        UINT64* slptr = (UINT64*)sr.localRootArguments.ptr;
        int loops = localRootArguments.size >> 3;
