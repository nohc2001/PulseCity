...
void Game::Init()
{
	...
	gd.GlobalTextureArr[(int)gd.GlobalDevice::GT_TileTex].CreateTexture_fromFile("Resources/Tiles036_1K-PNG_Color.png");
	gd.GlobalTextureArr[(int)gd.GlobalDevice::GT_WallTex].CreateTexture_fromFile("Resources/Chip001_1K-PNG_Color.png");
	gd.GlobalTextureArr[(int)gd.GlobalDevice::GT_Monster].CreateTexture_fromFile("Resources/PaintedMetal004_1K-PNG_Color.png");
