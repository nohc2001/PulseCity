...
void World::Init() {
	...
	AddClientOffset(GameObjectType::_Player, 192, 208); // DeltaMousePos

	AddClientOffset(GameObjectType::_Player, 160, 176); // Bullets
	AddClientOffset(GameObjectType::_Player, 164, 180); // KillCount
	AddClientOffset(GameObjectType::_Player, 168, 184); // DeathCount
	AddClientOffset(GameObjectType::_Player, 172, 188); // HeatGauge
	AddClientOffset(GameObjectType::_Player, 188, 192); // MaxHeatGauge
	...
	AddClientOffset(GameObjectType::_Monster, 226, 160); // isDead
	AddClientOffset(GameObjectType::_Monster, 200, 164); // HP
	AddClientOffset(GameObjectType::_Monster, 204, 168); // MaxHP
